import { NODE_MODULES_RE, baseBuildConfig, baseBuildPlugins, basename, getChunkName, importDep, isAbsolute, join, libChunkName, oxc, relative, writeBuildInfo } from "./common.mjs";

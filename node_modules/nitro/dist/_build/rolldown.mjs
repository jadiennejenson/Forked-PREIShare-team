import { NODE_MODULES_RE, baseBuildConfig, baseBuildPlugins, basename, getChunkName, join, libChunkName, relative, writeBuildInfo } from "./common.mjs";
import { formatCompatibilityDate } from "../_libs/compatx.mjs";
import { scanHandlers } from "../_chunks/nitro2.mjs";
...
async function watchDev(nitro, config) {
	...
	const watchReloadEvents = /* @__PURE__ */ new Set([
		"add",
		"addDir",
		"unlink",
		"unlinkDir"

...
- Default: `"latest"` behavior when not provided
...
- Type: `boolean` | `{ gzip?: boolean, brotli?: boolean, zstd?: boolean }`
- Default: `false`
...
- Type: `false` | `string` | `{ handler: string, format?: EventHandlerFormat }`
...
- Default: `[]` (the server source directory is scanned when empty)
...
- Type: `boolean` | `{ srvx?: boolean, h3?: boolean, unstorage?: boolean }`
- Default: `false`

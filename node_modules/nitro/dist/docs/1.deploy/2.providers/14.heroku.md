...
2. Change to the `node_middleware` preset in your Nitro config
...
3. As described in the **Existing app** section of the buildpack docs, two key steps are required to get things running:

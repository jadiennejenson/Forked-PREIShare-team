...
//#region src/routes/share.tsx?tsr-split=component
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
					...
					children: [/* @__PURE__ */ jsx("span", { children: isBusy ? "Saving..." : "Choose a file" }), /* @__PURE__ */ jsx("input", {
						type: "file",
						className: "sr-only",
			...
			files.length === 0 && !isBusy ? /* @__PURE__ */ jsxs("div", {
				...
				children: files.map((file) => /* @__PURE__ */ jsxs("article", {

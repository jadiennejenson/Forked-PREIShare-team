import { n as keyboardModifiers } from "./UGVNF6SI-CxUhV3P6.js";
import { A as createMemo, B as onMount, C as DEV, D as createComponent, E as batch, F as getOwner, H as untrack, L as mergeProps, M as createRoot, N as createSignal, O as createContext, P as getListener, R as on, S as use, T as Show, U as useContext, V as sharedConfig, _ as setAttribute, a as createPiPWindow, b as style, c as createStore, d as classList, f as className, h as memo, i as TANSTACK_DEVTOOLS, j as createRenderEffect, k as createEffect, l as Portal, m as insert, o as getAllPermutations, p as delegateEvents, s as uppercaseFirstLetter, t as DevtoolsContext, u as addEventListener, v as setStyleProperty, w as For, x as template, y as spread, z as onCleanup } from "./ZUSKEP2N-Cxh9cndt.js";
...
//#endregion
//#region node_modules/@tanstack/devtools-ui/dist/esm/styles/tokens.js
var tokens$1 = {
	colors: {
		inherit: "inherit",
...
var _tmpl$$6 = /* @__PURE__ */ template(`<div><label><input type=checkbox><div>`);
var _tmpl$2$5 = /* @__PURE__ */ template(`<span>`);
...
var _tmpl$$5 = /* @__PURE__ */ template(`<div><div><input>`);
var _tmpl$2$4 = /* @__PURE__ */ template(`<label>`);
var _tmpl$3$4 = /* @__PURE__ */ template(`<p>`);
...
var _tmpl$$4 = /* @__PURE__ */ template(`<div><div><select>`);
...
var _tmpl$2$2 = /* @__PURE__ */ template(`<svg xmlns=http://www.w3.org/2000/svg width=24 height=24 viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2 stroke-linecap=round stroke-linejoin=round><path d="M8 6h10"></path><path d="M6 12h9"></path><path d="M11 18h7">`);
var _tmpl$3$2 = /* @__PURE__ */ template(`<svg xmlns=http://www.w3.org/2000/svg width=24 height=24 viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2 stroke-linecap=round stroke-linejoin=round class="lucide lucide-file-search2-icon lucide-file-search-2"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"></path><path d="M14 2v4a2 2 0 0 0 2 2h4"></path><circle cx=11.5 cy=14.5 r=2.5></circle><path d="M13.3 16.3 15 18">`);
...
var _tmpl$$1 = /* @__PURE__ */ template(`<section>`);
var _tmpl$2$1 = /* @__PURE__ */ template(`<h3>`);
...
//#endregion
//#region node_modules/@tanstack/devtools/dist/devtools/4L5Y3KUW.js
...
function createDrawContext() {
	...
	if (context === void 0) throw new Error(`createDrawContext must be used within a DrawClientProvider`);
	return context;
}
...
var Trigger = (props) => {
	...
	const buttonStyle = createMemo(() => {
		return clsx(styles().mainCloseBtn, (!isFloating() || !coords()) && styles().mainCloseBtnPosition(settings().position), styles().mainCloseBtnAnimation(props.isOpen(), settings().hideUntilHover), isFloating() && styles().mainCloseBtnFloating);
	});
...
var PluginsTab = (props) => {
	...
	const { expanded, hoverUtils, animationMs, setForceExpand } = createDrawContext();
	...
	return (() => {
		...
		insert(_el$, createComponent(For, {
			...
			children: (tab) => (() => {
				...
				createRenderEffect((_p$) => {
					var _v$ = `tsd-tab-${tab.id}`, _v$2 = clsx(styles().tab, { active: state().activeTab === tab.id });
		...
		insert(_el$, (() => {
			...
			return () => _c$() ? null : (() => {
				...
				createRenderEffect((_p$) => {
					var _v$3 = clsx(styles().tab, "detach"), _v$4 = clsx(styles().tab, "close");

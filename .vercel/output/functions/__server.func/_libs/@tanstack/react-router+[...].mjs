...
//#endregion
export { GLOBAL_TSR, HeadContent, Link, RouterProvider, Scripts, TSR_SCRIPT_BARRIER_ID, createFileRoute, createInlineCssPlaceholderAsset, createInlineCssStyleAsset, createLRUCache, createRootRoute, createRouter, decodePath, defineHandlerCallback, executeRewriteInput, getScriptPreloadAttrs, getStylesheetHref, invariant, isNotFound, isRedirect, isResolvedRedirect, isSsrResponse, lazyRouteComponent, normalizeSsrResponse, renderRouterToStream, replaceSsrResponse, require_jsx_runtime, require_react, resolveManifestAssetLink, resolveManifestCssLink, rootRouteId, stripSsrResponseBody };
